          ...
          <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              <Link
                ...
                className="group flex items-center gap-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-brand-red hover:shadow-md sm:p-5"
              >
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            {location.zipCodes.map((zip) => (
              <span
                key={zip}
                className="rounded-lg border border-brand-red bg-red-50 px-5 py-3 text-lg font-bold text-brand-red"
              >
                {zip}
              </span>
            ))}
