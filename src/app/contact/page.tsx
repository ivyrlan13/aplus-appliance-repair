            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <a
                  ...
                  className="mt-2 block text-3xl font-extrabold text-brand-red transition-colors hover:text-red-700 sm:text-4xl"
                >
                  {business.phone}
                </a>
              ...
              <div className="mt-8">
                ...
                <a
                  ...
                  className="mt-2 block text-lg font-medium text-brand-blue transition-colors hover:text-blue-600"
                >
                  {business.email}
                </a>
              </div>
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-lg font-medium text-brand-body">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {locations.map((location) => (
                    <Link
                      ...
                      className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium text-brand-body transition-colors hover:border-brand-red hover:bg-red-50 hover:text-brand-red"
                    >
                      {location.name}
                    </Link>
                  ))}
            ...
            <div>
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 shadow-sm sm:p-8">
                ...
                <form className="mt-6 space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-brand-red px-6 py-4 text-base font-bold text-white shadow-sm transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-brand-red focus:ring-offset-2"
                  >
                    Request Service
                  </button>
